<template>
  ...
  <el-card style="margin:10px 0">
    ...
    <div v-show="scene==0">
        <!-- 添加SPU按钮 -->
        <el-button type="primary" icon="Plus" @click="addSpu" style="margin:10px 0" :disabled="categoryStore.c3Id?false:true">添加SPU</el-button>
        <!-- SPU展示 -->
...
const getSpu = async(pager=1)=>{
    pageNo.value = pager
    let result:SpuDataResponse = await reqSpuData(categoryStore.c3Id,pageNo.value,limit.value)
    if(result.code==200){
        // 存储数据
